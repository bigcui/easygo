...
'use strict';
const boilerplate = require('easy-cli-boilerplate');
...
module.exports = {
    ...
    page: function(options) {
        console.log(options);
        const content = render.render(boilerplate.readTemplate('easy.html'), options);
    ...
    element: function(options) {
        // 模板生成映射
        const templateMap = {
            'nav.vue': '${name}/${name}.vue',
            'easy.less': '${name}/${name}.less',
