<template>
    <a ref="jLabel" class="easygo-test" href="javascript:;" v-html="content" :style="{margin: margin, width: width, height: height, background: backgroundColor}" :class="{invisible: !isInIDE && visible === 'false'}">
    </a>
</template>
<script>
